...
SECRET_KEY = os.environ.get("SECRET_KEY", "django-insecure-)^+-tylezyo6+e4fp7*s5ngpkx+5sq1ll$c4jxk^d9e*9^$4kd")

DEBUG = os.environ.get("DEBUG", "False") == "True"

ALLOWED_HOSTS = ['kamilk38.pl', 'www.kamilk38.pl', '168.119.96.187', 'localhost']
...
CELERY_BEAT_SCHEDULE = {
    "refresh-weather-every-hour": {
        "task": "weather.tasks.refresh_popular_cities",
